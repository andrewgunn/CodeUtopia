...
using BankReporting.ProjectionStore.EntityFramework.AccountDetail;
using BankReporting.ProjectionStore.EntityFramework.Client;
using BankReporting.ProjectionStore.EntityFramework.ClientDetail;
