...
{
    public class BookLentEventHandler : IHandleMessages<BookBorrowedEvent>
    {
        public BookLentEventHandler(IProjectionStoreDatabaseSettings projectionStoreDatabaseSettings)
        {
